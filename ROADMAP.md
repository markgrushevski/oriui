...
4. ✅ **Headless layer** — swappable behavior **contract** (`OriHeadless` plugin): **native** zero-dep
   ...
   in `@oriui/vue`.
5. 🔄 **Styled components** — **30 shipped** (actions, forms, overlays, layout, feedback, navigation,
...
7. 🔄 **Docs** — a **Nuxt 4 + Nuxt Content 3** app, its own UI built on oriUI itself (not VitePress).
   ✅ a full page per component (30 — intro + classes + props/slots + a11y, with live demos on the page,
