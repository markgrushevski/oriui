...
import { OriTag } from '../packages/vue/src/components/tag'
...
describe('OriTag', () => {
    ...
    it('renders appendIcon when provided', () => {
        ...
        expect(textEl.element.compareDocumentPosition(lastIcon.element) & Node.DOCUMENT_POSITION_FOLLOWING).toBeTruthy()
    })
