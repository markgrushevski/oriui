...
### ORI-I-87 — `OriAccordion`'s default slot fanned out, and unlike Tabs the duplicates were VISIBLE

`fixed` · severity `should-fix` · source: reference audit 2026-09-19, measured here and by the skeptic
