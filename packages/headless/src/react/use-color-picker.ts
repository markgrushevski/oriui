...
export function useColorPicker(options: UseColorPickerOptions) {
    ...
    const areaProps = {
        ...
        style: { '--ori-color-picker-hue': hueColor },
    ...
    // screen reader announces it (APG has no ColorArea or ColorPicker pattern — this is$1    // the general slider contract, not a citation: Up/Down on "Saturation" must NOT silently
