...
Five visual styles, all driven by the `ori-variant_*` utilities. The default is `solid` on `surface`.

::example
:ori-card{variant="solid" color="surface" title="Solid" text="Default solid on surface."}
...
```vue
<OriCard variant="solid" title="Solid" text="Default solid on surface." />
...
::example
:ori-card{variant="soft" color="primary" title="primary"}
:ori-card{variant="soft" color="secondary" title="secondary"}
:ori-card{variant="soft" color="success" title="success"}
:ori-card{variant="soft" color="warning" title="warning"}
:ori-card{variant="soft" color="danger" title="danger"}
:ori-card{variant="soft" color="info" title="info"}
:ori-card{variant="soft" color="surface" title="surface (default)"}
:ori-card{variant="soft" color="background" title="background"}

#vue

```vue
<OriCard variant="soft" color="primary" title="primary" />
<OriCard variant="soft" color="secondary" title="secondary" />
<OriCard variant="soft" color="success" title="success" />
<OriCard variant="soft" color="warning" title="warning" />
<OriCard variant="soft" color="danger" title="danger" />
<OriCard variant="soft" color="info" title="info" />
<OriCard variant="soft" color="surface" title="surface (default)" />
<OriCard variant="soft" color="background" title="background" />
```

#html

```html
<div class="ori-card ori-size-radius_lg ori-variant_soft ori-color_danger">
    <div class="ori-card__header">
        <div class="ori-card__headline"><div class="ori-card__title">danger</div></div>
    </div>
</div>
<!-- swap the color: ori-color_danger → ori-color_primary / ori-color_secondary / ori-color_success / ori-color_warning / ori-color_info / ori-color_surface / ori-color_background -->
```
...
::example
:ori-card{variant="solid" color="danger" title="Delete zone" text="This action is irreversible."}
:ori-card{variant="outline" color="info" title="Note" text="Extra context lives here."}
:ori-card{variant="soft" color="success" title="All clear" text="Everything looks good."}

#vue

```vue
<OriCard variant="solid" color="danger" title="Delete zone" text="This action is irreversible." />
<OriCard variant="outline" color="info" title="Note" text="Extra context lives here." />
<OriCard variant="soft" color="success" title="All clear" text="Everything looks good." />
```

#html

```html
<div class="ori-card ori-size-radius_lg ori-variant_solid ori-color_danger">
    <div class="ori-card__header">
...
From `none` (sharp) to `full` (pill-like). The default is `lg`.

::example
:ori-card{radius="none" title="none" text="No corner radius."}
...
:ori-card{radius="full" title="full" text="Maximum radius."}

#vue

```vue
<OriCard radius="none" title="none" text="No corner radius." />
<OriCard radius="lg" title="lg (default)" text="Default rounding." />
<OriCard radius="full" title="full" text="Maximum radius." />
```
...
```html
<div class="ori-card ori-card_row ori-size-radius_lg ori-variant_solid ori-color_surface">
    <div class="ori-card__header">
        <div class="ori-card__header-prepend">
            <i class="ori-icon ori-icon_sm" aria-hidden="true">
...
```html
<div class="ori-card ori-card_fluid ori-size-radius_lg ori-variant_solid ori-color_surface">
    <div class="ori-card__header">
...
```html
<div class="ori-card ori-size-radius_lg ori-variant_solid ori-color_surface" aria-disabled="true">
    <div class="ori-card__header">
...
<div class="ori-card ori-size-radius_lg ori-variant_solid ori-color_surface" aria-busy="true">
    <div class="ori-card__header">
...
>
    <template #actions-append>
        ...
        <OriButton variant="solid" color="danger">Delete</OriButton>
    </template>
</OriCard>
...
>
    <template #actions-append>
        ...
        <OriButton variant="soft" color="primary">Save</OriButton>
    </template>
</OriCard>
```
...
```html
<!-- Notification card with action row -->
<div class="ori-card ori-size-radius_lg ori-variant_outline ori-color_warning">
    <div class="ori-card__header">
        <div class="ori-card__headline">
    ...
    <div class="ori-card__actions">
        ...
        <button class="ori-button ori-variant_solid ori-color_danger">Delete</button>
    </div>
</div>
...
<div class="ori-card ori-size-radius_lg ori-variant_solid ori-color_surface">
    ...
    <div class="ori-card__actions ori-card__actions_reverse">
        ...
        <button class="ori-button ori-variant_soft ori-color_primary">Save</button>
    </div>
</div>
```
...
| `color`                   | `ThemeColor` | `'surface'` | Semantic role: primary · secondary · success · warning · danger · info · surface · background. |
...
| `radius`                  | `RadiusSize` | `'lg'`      | Corner radius: `none` · `xs` · `sm` · `md` · `lg` · `xl` · `full`.                             |
